...
const makeSources = (category: SourceCategory, rows: Array<[string, string]>): SourceDefinition[] =>
  rows.map(([name, url]) => ({
    id: name
      .toLowerCase()
      .replace(/[^a-z0-9]+/g, "-")
...
export const SOURCE_REGISTRY: SourceDefinition[] = [
  ...makeSources("Imprensa", [
    ...
    ["The Intercept Brasil", "https://www.intercept.com.br/"],
  ...
  ...makeSources("Rede Social", [
    ...
    ["Discord public indexes", "https://discord.com/"],
  ...
  ...makeSources("Comunidade", [
    ...
    ["Discourse public forums", "https://www.discourse.org/"],
  ]),
  ...makeSources("Chan / Deepweb pública", [
    ...
    ["8kun", "https://8kun.top/"],
    ["Endchan", "https://endchan.net/"],
    ["Lainchan", "https://lainchan.org/"],
    ["Wizardchan", "https://wizardchan.org/"],
  ...
  ...makeSources("Enciclopédia", [
    ...
    ["Encyclopaedia.com", "https://www.encyclopedia.com/"],
